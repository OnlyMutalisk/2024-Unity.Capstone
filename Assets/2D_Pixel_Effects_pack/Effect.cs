...
public class Effect : MonoBehaviour
{
    ...
    private IEnumerator CorPlay(Effects effect, Vector2 pos, float scale, int time)
    {
        ...
        // 크기 조정
        Vector2 originScale = obj.transform.localScale;
        obj.transform.localScale = new Vector2(originScale.x * scale, originScale.y * scale);

        // 시간 조정
        GameObject prefab = Instantiate(obj, pos, Quaternion.identity);
