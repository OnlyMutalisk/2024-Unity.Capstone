...
public class GameManager1 : MonoBehaviour
{
    ...
    public static void SAVE()
    {
        Data data = new Data
        {
            ...
            playerAction = GameManager1.playerAction,
            playerTileProperty = GameManager1.playerTileProperty
        };
...
public class Data
{
    public GameManager1.PlayerAction playerAction;
    public GameManager1.TileProperty playerTileProperty;
}
